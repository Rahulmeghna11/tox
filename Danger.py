...
TOKEN = '7973256114:AAG0IZxtShhZJCkst_ua-UoAT6gbNjkYfCg'
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"  # Access Denied message
                                       ...
                                       "*Contact the owner for assistance: @RAHUL_DDOS_B .*", parse_mode='Markdown')  # Contact owner message
            return
...
def myinfo_command(message):
    ...
    if not user_data:
        ...
        response += "*Koi bhi problem ho to baap se baat kar: RAHUL_DDOS_B * "  # Contact owner message
...
def start_message(message):
    try:
        bot.send_message(message.chat.id, "*🌍 WELCOME TO RAHUL DDOS WORLD!* 🎉\n\n"
